...
module IF_ID #(
  ...
  // JAL, JALR, BRANCH, LOAD, STORE, ARITH-I, LUI, AUIPC
  ...
  always @(*) begin
    ...
    case (decode_inst[`OPCODE])
      ...
      // Lower 12 bits = 0
      LUI,
      AUIPC: immediate = {decode_inst[31:12], 12'b0};
      ...
      // FENCE/FENCE.I and ECALL/EBREAK are accepted as legal no-ops in this
      // simple bare-metal core because there is no cache, privilege, or trap unit.
      FENCE,
      SYSTEM: immediate = 32'h0;
  ...
  id_ex_reg u_id_ex (
      ...
      .auipc_i(decode_inst[`OPCODE] == AUIPC),
